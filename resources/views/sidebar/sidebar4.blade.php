...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="css1/app1.css">
...
<div class="row container-fluid">
    <div id="side" class="sidebar col-2 nav-hover " style=" height:870px; width:280px">

        <div class="d-flex " style="margin-right: 2% " >
            <div> <img src="p12.jpg"  class="rounded-circle " style="width: 90px; height: 90px ;margin-top:18%" ></div>
            <div class="" style="margin-top: 12%;padding-right:6%">
